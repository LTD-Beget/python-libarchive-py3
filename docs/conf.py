...
latex_documents = [
    ('index', 'python-libarchive.tex', 'python-libarchive Documentation', 'Ben Timby', 'manual'),
]
...
man_pages = [('index', 'python-libarchive', 'python-libarchive Documentation', ['Ben Timby'], 1)]
